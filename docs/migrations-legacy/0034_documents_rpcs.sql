-- 0034 — Dokumente-Ausbau (Teil 2: RPCs)
--
-- Läuft nach 0033, wo der neue Enum-Wert 'document_review' hinzugefügt
-- wurde. Diese Migration definiert die Funktionen, die den neuen Wert
-- verwenden.

-- ── Reichere Dokument-Liste für die App ───────────────────────────
-- Liefert für die Freigabe-Kachel:
--   Titel, Kategorie, Version, Status, Gültigkeit, Ablauf-Status
--   (ok / expiring / expired / none), Pfad der aktuellen Version.
...
-- ── Freigabe-Anfrage für ein Dokument (nutzt document_approvals) ────
...
-- ── Ablauf-Setter (Fälligkeitsdatum) ───────────────────────────────
-- Nur Gesellschafter/Admin dürfen valid_until setzen.

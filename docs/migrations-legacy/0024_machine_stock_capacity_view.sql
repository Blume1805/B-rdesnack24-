-- 0024 — machine_stock-View um image_url + capacity erweitern.
-- capacity ersetzt par_level als „Total" in der Kundenanzeige.
-- par_level bleibt als Nachfüll-Schwelle für Status-Bewertung.

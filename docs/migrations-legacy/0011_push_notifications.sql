-- ============================================================================
-- 0011 — Push-Benachrichtigungen (FCM): Gerätetokens & Benachrichtigungslog
-- ============================================================================
...
-- ── Gerätetokens (je Nutzer mehrere Geräte) ─────────────────────────────────
...
-- Audit (Tokens sind sicherheitsrelevant)
select app.enable_audit('public.device_tokens');

-- ============================================================================
-- RLS — Nutzer verwalten ausschließlich eigene Tokens/Benachrichtigungen.
-- Versand erfolgt serverseitig (Edge Function mit Service-Role).
-- ============================================================================
...
create policy notif_update on public.notifications for update to authenticated
  using (user_id = auth.uid()) with check (user_id = auth.uid());
-- Insert nur serverseitig (Service-Role) -> keine Insert-Policy.

-- ============================================================================
-- 0009 — RPC my_permissions(): effektive Berechtigungen des aktuellen Nutzers
-- ----------------------------------------------------------------------------
-- Für UI-Gating (Sichtbarkeit). Autorisierung bleibt serverseitig (RLS) —
-- diese Liste ist nur ein Komfort für die Oberfläche.
-- ============================================================================
...
comment on function public.my_permissions() is
  'Liefert die effektiven Permission-Keys des aktuellen Nutzers (RBAC ∪ ABAC − Entzüge). Nur für UI-Gating.';

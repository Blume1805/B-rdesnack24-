-- 0051 — Preise in Katalog-View und Produktdetail.
--
-- Für die App-Preis-Anzeige (Automatenpreis vs. −5 % App-Preis) brauchen
-- Client-Katalog (machine_stock) und Produktdetail (product_detail) den
-- Netto-Listenpreis UND den Steuersatz — der Bruttopreis wird im Client
-- berechnet (Pricing.appPriceGross).

-- machine_stock um Preisspalten erweitern; security_invoker bleibt
-- erhalten (Basistabellen sind für authenticated lesbar, Hardening 0045).
...
-- product_detail um tax_rate erweitern (neue Signatur-Spalte am Ende).

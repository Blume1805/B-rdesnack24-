...
| CUST-002 | Profil-E-Mail ändern | D3/D4 | ✓ | ✗ | — | ✗ | ✗ | offen | ✗ | 🔴 S-5 |
...
| CUST-010 | Produktbewertung abgeben/lesen | D3 | ✓ | ✓ | — | ✗ | ✗ | offen | ✗ | 🔴 S-4 |
| CUST-011 | Produktdetails (`product_detail`) | D0 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | 🟢 |
| CUST-012 | Produktkatalog über Tabelle `products` | D2 | ✓ | ✗ | — | ✗ | ✗ | offen | ✗ | 🔴 S-2 |
...
² Prüfdaten enthielten keine Rechnung; Test lief, war nicht aussagekräftig.
...
| PAY-002 | `choose_subscription_plan` — Altersschranke | D5 | ✓ | ✓ | ✗ | — | ✗ | 🔴 S-6 |
...
| --- | --- | --- | --- | --- | --- | --- |
| GES-001 | 48 Verwaltungs-RPCs gegen Kundenkonto | D2 | ✓ | ✓ | 47/48 ✓ | 🔴 S-12 |
| GES-002 | `finance_*` (Buchhaltung) | D6 | ✓ | ✓ | ✓ | 🟢 |
| GES-003 | `inventory_*` (Bestand, FIFO, EK) | D2 | ✓ | ✓ | ✓ | 🟢 |
| GES-004 | `pkw_*`, `audit_log` | D2 | ✓ | ✓ | ✓ | 🟢 |
| GES-005 | `machine_sales_daily` (Tagesumsatz) | D2 | ✓ | ✗ | ✗ | 🔴 S-3 |
| GES-006 | `inventory` (Fachbestand, MHD) | D2 | ✓ | ✗ | ✗ | 🔴 S-9 |
| GES-007 | Rollen- und Rechtekatalog lesbar | D1 | ✓ | ✗ | ✗ | 🔴 S-8 |
| GES-008 | `auth_has_permission(perm, fremde uid)` | D1 | ✓ | ✗ | ✗ | 🔴 S-11 |
...
| AUTH-005 | Schutz vor kompromittierten Passwörtern | ✗ im Dashboard aus | 🔴 S-13 |
...
| DB-002 | Bucket-Grenzen (Größe, MIME) | ✓ nicht gesetzt | 🔴 S-10 |
| MAIL-001 | Webhook-Signaturen ohne Rückfallwert | ✓ Code | 🟢 |
| MAIL-002 | `email_enqueue` Empfängerbestimmung | ✓ | 🔴 S-5 |
| MAIL-003 | `email_report_share` / `fetch_email_report_share` | ✓ | 🔴 S-1 |
| MAIL-004 | Zustellung über Resend an Testpostfach | ✗ kein Testpostfach | 🔴 |
| DOC-001 | Änderungsprotokoll buchführungsrelevanter Tabellen | ✓ | 🔴 S-7 |
...
benanntem fehlendem Mittel — nicht Gelb.

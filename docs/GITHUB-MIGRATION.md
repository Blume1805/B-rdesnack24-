...
|---|---|
| Backend, Flutter-App, Migrationen, Prüfumgebung, Dokumentation | `github.com/Blume1805/B-rdesnack24-` — **öffentlich**, Monorepo-Aufbau (`apps/kunden-app`, `apps/gesellschafter-app`, `apps/landing`, `packages/bs24_kern`, `packages/api-types`, `supabase/`, `scripts/`, `docs/`), vier GitHub-Workflows |

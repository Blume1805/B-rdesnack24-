...
gesetzlichen Gewährleistungsrechte. Melde das bitte per E-Mail oder über das
Kontaktformular in der App — wir erstatten oder ersetzen.
...
dafür gibt es die Seite „Abo kündigen", die auch ohne Anmeldung erreichbar ist
(§ 312k BGB) — auf dieser Website im Fußbereich und in der App im Bereich
„Rechtliches".
...
Diese Website gibt sie wieder, damit du vor dem Herunterladen weißt, worauf du
dich einlässt. Das blosse Lesen dieser Website begründet keinen Vertrag: Für sie
brauchst du kein Konto, und du kannst hier weder kaufen noch ein Abo
abschliessen.

Ergänzend gelten als eigene Dokumente: Datenschutzerklärung, Widerrufsbelehrung,
Zahlungsinformationen, Cookie- und Tracking-Hinweise sowie die
Barrierefreiheitserklärung. Wo diese Bedingungen darauf verweisen, ist der
dortige Text massgeblich.

Auf dieser Website stehen im Fussbereich Impressum, Datenschutzerklärung,
Widerrufsbelehrung und „Abo kündigen". Die übrigen Dokumente betreffen
Funktionen, die es nur in der App gibt, und stehen dort im Bereich
„Rechtliches".
...
Wir bieten zwei Modelle an, beide Preise inklusive gesetzlicher Umsatzsteuer:
...
Die kostenlose Nutzung bleibt davon unberührt. Sie ist keine Testphase, die
ausläuft, und sie verlangt keine Zahlungsdaten.
...
die Seite „Abo kündigen", die auch ohne Anmeldung erreichbar ist (§ 312k BGB)
und die es auf dieser Website wie in der App gibt, im Kundenbereich unter
„Mein Abo", und nach der Store-Veröffentlichung zusätzlich über die
Abo-Verwaltung des Stores. Den Zugang
...
Stand 09/2026: Die App ist noch nicht im App Store und nicht bei Google Play.
Bis dahin lässt sich kein Abo abschliessen und wird nichts abgebucht.
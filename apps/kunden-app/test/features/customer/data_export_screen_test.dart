import 'package:bs24_kunden/features/customer/presentation/screens/data_export_screen.dart';
  ...
  group('bereicheAusAuskunft', () {
    ...
    test('alle 38 Bereiche der Datenbankfassung werden übersetzt', () {
      ...
      const schluessel = [
        ...
        'store_abo',
        'kuendigungen',
        'persoenliche_angebote',
        'aktivierte_angebote',
        'bonusstufen',
        'challenge_gutschriften',
        'anmeldetage',
        'empfehlungen_fuer_mich',
        'bewertungen',
        'spendenstimmen',
        'werbeklicks',
        'mein_empfehlungscode',
        'empfehlungen_von_mir',
        'empfehlung_die_mich_warb',
        'empfehlungspraemien',
        'firmenmitgliedschaften',
        'geraete',
        'kundenkarte',
        'abmeldetoken_besteht',
        'loeschantraege',
        'ifsg_belehrungen',
        'schulungen',
      ];

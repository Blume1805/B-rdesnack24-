...
class _ProviderFormState extends ConsumerState<_ProviderForm> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await client.rpc('register_telemetry_provider', params: {
      ...
      child: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text('Telemetrie-Provider anlegen',
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(p?['name']?.toString() ?? '— kein Produkt zugeordnet —',
                      style: AppTypography.body(
                          size: 14,
                          weight: FontWeight.w800,
                          color: AppColors.ink)),
...
class _SlotFormState extends ConsumerState<_SlotForm> {
  ...
  Future<void> _submit() async {
    ...
    final client = ref.read(supabaseClientProvider);
    try {
      await client.rpc('set_machine_slot', params: {
      ...
      child: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              Text(widget.existing == null ? 'Slot anlegen' : 'Slot bearbeiten',
                  style: Theme.of(context).textTheme.titleLarge),
              const SizedBox(height: 16),
              TextFormField(

import 'package:bs24_kern/core/widgets/design_system/eu_ki_kennzeichen.dart';
import 'package:bs24_kern/core/widgets/design_system/product_image.dart';
...
void main() {
  group('EuKiKennzeichen', () {
    testWidgets('erzeugtes Bild nutzt das Motiv AI GENERATED', (tester) async {
      ...
      expect(
        ...
        'packages/bs24_kern/assets/images/ki/eu-ki-generiert.png',
      );
    });
    ...
    testWidgets('bearbeitetes Bild nutzt das Motiv AI MODIFIED',
      ...
      expect(
        (bild.image as AssetImage).assetName,
        'packages/bs24_kern/assets/images/ki/eu-ki-bearbeitet.png',
      );
    });
    ...
    testWidgets('kompakt nutzt das Grundsymbol', (tester) async {
      ...
      expect(
        (bild.image as AssetImage).assetName,
        'packages/bs24_kern/assets/images/ki/eu-ki-basis.png',
      );
    });
    ...
    testWidgets('die Tippflaeche ist mindestens 44 Punkt hoch', (tester) async {
      await tester.pumpWidget(
        _rahmen(
          EuKiKennzeichen(
            herkunft: KiHerkunft.vollstaendigErzeugt,
  ...
  group('ProductImage mit Kennzeichnung', () {
    ...
    testWidgets('auf einem Vorschaubild schaltet es aufs Grundsymbol',
      ...
      expect(
        tester.widget<EuKiKennzeichen>(find.byType(EuKiKennzeichen)).kompakt,
        isTrue,
      );
    });

...
import 'package:bs24_kern/core/auth/recovery_link.dart';
import 'package:bs24_kern/core/config/app_config.dart';
import 'package:bs24_kern/core/di/providers.dart';
import 'package:bs24_kern/core/security/biometrie/biometrie_provider.dart';
...
///
/// [sitzungsSchluessel] trennt die Sitzungsablagen der beiden Apps. Sie
/// laufen auf demselben Geraet und (in der Web-Demo) unter Umstaenden auf
/// derselben Herkunft; mit einem gemeinsamen Schluessel wuerde die zuletzt
/// gestartete App die Sitzung der anderen ueberschreiben.
Future<void> bootstrap({
  required Widget app,
  required String sitzungsSchluessel,
}) async {
  ...
  final biometrie = biometrieAufbauen(
    offen: SharedPreferencesLocalStorage(
      persistSessionKey: sitzungsSchluessel,
    ),
  );

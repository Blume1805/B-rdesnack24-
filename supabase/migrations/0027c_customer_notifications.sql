-- ============================================================================
-- 0027c · Benachrichtigungen im Kundenbereich (nachgetragen)
-- ----------------------------------------------------------------------------
-- Angewendet am 11.07.2026 (Version 20260711105211), nie als Datei abgelegt.
-- `customer_notification_reads` kam im gesamten Repository kein einziges Mal
-- vor — mit der Tabelle fehlten auch vier Funktionen, die der Kundenbereich
-- produktiv nutzt.
--
-- Inhalt zurückgeholt aus `supabase_migrations.schema_migrations.statements`,
-- also das tatsächlich ausgeführte SQL, nicht nachgebaut.
--
-- Gegen die laufende Datenbank ein Leerlauf (`if not exists`,

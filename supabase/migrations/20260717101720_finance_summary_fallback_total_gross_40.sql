-- 0040 — Fallback: purchases ohne purchase_items trotzdem berücksichtigen.
--
-- Beobachtung: die aktuellen Demo-Purchases haben zwar total_gross, aber
-- keine korrespondierenden purchase_items. Die Aggregation aus 0039
-- fiel deswegen auf 0 zurück. Fix: für Purchases ohne Items nehmen wir
-- total_gross direkt und rechnen es mit 7 % Steuersatz um.

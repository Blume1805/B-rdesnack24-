-- 0131 — Die Richtung einer Kontozeile kommt aus der Buchung, nicht aus dem
-- Kontenstamm. Sonst zeigt die Kontoübersicht 0480 (Stamm: asset) grau, die
-- Einzelbuchungen dieselbe Anschaffung aber rot als Aufwand.
-- Volltext und Begründung:
-- supabase/migrations/0131_richtung_kommt_aus_der_buchung.sql

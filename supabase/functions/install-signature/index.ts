...
//      einkompiliertem Rückfallwert. War die Variable im Projekt nicht
//      gesetzt, stand das Geheimnis im ausgelieferten Code. Ein
//      Rückfallwert ist bei einem Geheimnis kein Komfort, sondern die
//      Abschaffung des Geheimnisses.
//   3. Geschrieben wurde mit dem Service-Role-Schlüssel, also an RLS
//      vorbei — und der Ablagepfad kam ungeprüft aus dem Header
//      `x-signature-id`, mit `upsert: true`.
//
